...
public class FlutterSegmentOptions {
    ...
    public  FlutterSegmentOptions(String writeKey, Boolean trackApplicationLifecycleEvents, Boolean amplitudeIntegrationEnabled, Boolean appsFlyerIntegrationEnabled, Boolean debug) {
    ...
    public Boolean isAmplitudeIntegrationEnabled() {
        ...
        return zppsFlyerIntegrationEnabled;
    }
